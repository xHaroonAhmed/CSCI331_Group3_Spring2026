...
-- =============================================
-- PERSON 3 - FINAL SUBMISSION
-- 5 Dimension Loading Procedures + Alias Wrappers
-- All fixes applied and tested
-- =============================================

-- =============================================
-- VIEWS (for cleaner queries)
-- =============================================
...
-- =============================================
-- PROCEDURE 1: Load DimCustomer
-- CustomerKey is IDENTITY - auto-generated
-- =============================================
...
BEGIN
    ...
    -- Don't insert CustomerKey - it's IDENTITY!
...
-- =============================================
-- PROCEDURE 2: Load DimGender
-- Natural key: Gender column
-- =============================================
...
BEGIN
    ...
    SELECT
        src.Gender,
        src.Gender,  -- Use same value for description
        @GroupMemberUserAuthorizationKey,
        SYSDATETIME(),
        SYSDATETIME()
...
-- =============================================
-- PROCEDURE 3: Load DimMaritalStatus
-- Natural key: MaritalStatus column
-- =============================================
...
-- =============================================
-- PROCEDURE 4: Load DimOccupation
-- OccupationKey: NOT IDENTITY, must use sequence explicitly
-- =============================================
...
BEGIN
    ...
    -- OccupationKey must be explicitly inserted using sequence
...
-- =============================================
-- PROCEDURE 5: Load DimOrderDate
-- Natural key: OrderDate column
-- =============================================
...
-- =============================================
-- ALIAS WRAPPERS FOR PERSON 6 COMPATIBILITY
-- Person 6's code expects [Process] schema with @UserAuthorizationKey
-- =============================================
