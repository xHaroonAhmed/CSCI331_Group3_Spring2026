...
-- ============================================================
-- Person 2 (Ralph) - Database Architect
-- 01_DatabaseSchema_Setup.sql  --  FIXED VERSION
-- Changes:
--   + Added EOS_Group_3 schema (required by Person 3 views)
--   + Filled in real team member names in UserAuthorization
--   + Removed duplicate [Process].[usp_LoadStarSchema]
--     (Person 6 owns the master orchestrator)
-- ============================================================


-- ============================================================
-- SECTION 1: Drop all FK constraints before dropping tables
-- ============================================================
...
-- ============================================================
-- SECTION 2: Drop and recreate tables (child -> parent order)
-- ============================================================
...
-- FIX: Added EOS_Group_3 schema required by Person 3 views
-- ============================================================
...
-- FIX: Replaced placeholder names with real team member names
